...
class Reversi : public Game {
    ...
    public:
        ...
        /**
         * @brief Indica todas as direções possíveis para realizar um movimento.
         */
         ...
         */
        void find_all_directions_to_make_move(std::array<int, 2>& move_coordinates, char player_piece, 
